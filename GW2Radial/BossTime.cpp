...
#pragma endregion
	...
	bool BossTime::_DoUI(bool &ison)
	{
		if (ison)
		{
			...
			ImGui::BeginChild("scrolling", ImVec2(360 * daxiao_, 115* daxiao_), false);
			...
			for (int t = 0; t < 5; t++)
			{
				...
				if (t == 0)
				{
					for (int i = 0; i < 97; i++)
					{
						...
						char num_buf[32];
						char str3[32];
						const char* label = BossName(BSPX1[i]);
						if (BSPX1[i] != 0)
						{
							sprintf_s(num_buf, u8"[%02d:%02d]", h, s);
							strcpy_s(str3, num_buf);
						...
						if (ImGui::Button(label, ImVec2(120.0f * daxiao_, 22.0f * daxiao_)))
						{
							if (BSPX1[i] != 0)
							{
								...
								std::string arrc2 = BossPost(BSPX1[i]);
				...
				if (t == 1)
				{
					for (int i = 0; i < 97; i++)
					{
						...
						char num_buf[32];
						char str3[32];
						const char* label = BossName(BSPX2[i]);
						if (BSPX2[i] != 0)
						{
							sprintf_s(num_buf, u8"[%02d:%02d]", h, s);
							strcpy_s(str3, num_buf);
						...
						ImGui::PushStyleColor(ImGuiCol_ButtonActive, (ImVec4)ImColor::HSV(hue, 0.8f, 0.8f));
						if (ImGui::Button(label, ImVec2(120.0f * daxiao_, 22.0f * daxiao_)))
							//if (ImGui::Button(BossName(BSPX2[i]), ImVec2(120.0f, 22.0f)))
						{
							if (BSPX2[i] != 0)
							{
								std::string arrc1 = label;
								std::string arrc2 = BossPost(BSPX2[i]);
								std::string arrc3 = u8" 来自\"gw2sy.top\"神油boss提示器";
								ImGui::SetClipboardText((arrc1 + arrc2 + arrc3).c_str());
							}
						}
				...
				if (t == 2)
				{
					for (int i = 0; i < 97; i++)
					{
						...
						char num_buf[32];
						char str3[32];
						const char* label = BossName(BSPX3[i]);
						if (BSPX3[i] != 0)
						{
							sprintf_s(num_buf, u8"[%02d:%02d]", h, s);
							strcpy_s(str3, num_buf);
						...
						ImGui::PushStyleColor(ImGuiCol_ButtonActive, (ImVec4)ImColor::HSV(hue, 0.8f, 0.8f));
						if (ImGui::Button(label, ImVec2(120.0f * daxiao_, 22.0f * daxiao_)))
							//if (ImGui::Button(BossName(BSPX3[i]), ImVec2(120.0f, 22.0f)))
						{
							if (BSPX3[i] != 0)
							{
								std::string arrc1 = label;
								std::string arrc2 = BossPost(BSPX3[i]);
								std::string arrc3 = u8" 来自\"gw2sy.top\"神油boss提示器";
								ImGui::SetClipboardText((arrc1 + arrc2 + arrc3).c_str());
							}
						}
				...
				if (t == 3)
				{
					for (int i = 0; i < 97; i++)
					{
						...
						char num_buf[32];
						char str3[32];
						const char* label = BossName(BSPX4[i]);
						if (BSPX4[i] != 0)
						{
							sprintf_s(num_buf, u8"[%02d:%02d]", h, s);
							strcpy_s(str3, num_buf);
						...
						ImGui::PushStyleColor(ImGuiCol_ButtonHovered, (ImVec4)ImColor::HSV(hue, 0.7f, 0.7f));
						ImGui::PushStyleColor(ImGuiCol_ButtonActive, (ImVec4)ImColor::HSV(hue, 0.8f, 0.8f));
						//if (ImGui::Button(BossName(BSPX4[i]), ImVec2(120.0f, 22.0f)))
						if (ImGui::Button(label, ImVec2(120.0f * daxiao_, 22.0f * daxiao_)))
						{
							if (BSPX4[i] != 0)
							{
								std::string arrc1 = label;
								std::string arrc2 = BossPost(BSPX4[i]);
								std::string arrc3 = u8" 来自\"gw2sy.top\"神油boss提示器";
								ImGui::SetClipboardText((arrc1 + arrc2 + arrc3).c_str());
							}
						}
				...
				if (t == 4)
				{
					for (int i = 0; i < 97; i++)
					{
						...
						char num_buf[32];
						char str3[32];
						const char* label = BossName(BSPX5[i]);
						if (BSPX5[i] != 0)
						{
							sprintf_s(num_buf, u8"[%02d:%02d]", h, s);
							strcpy_s(str3, num_buf);
						...
						ImGui::PushStyleColor(ImGuiCol_ButtonActive, (ImVec4)ImColor::HSV(hue, 0.8f, 0.8f));
						if (ImGui::Button(label, ImVec2(120.0f * daxiao_, 22.0f * daxiao_)))
						//if (ImGui::Button(BossName(BSPX5[i]), ImVec2(120.0f, 22.0f)))
						{
							if (BSPX5[i] != 0)
							{
								std::string arrc1 = label;
								std::string arrc2 = BossPost(BSPX5[i]);
								std::string arrc3 = u8" 来自\"gw2sy.top\"神油boss提示器";
								ImGui::SetClipboardText((arrc1 + arrc2 + arrc3).c_str());
							}
						}
			...
			//if (ImGui::SmallButton(u8"测试1"))
			//{
			//	DBINGtool::i()->getitim();
			//}
			//if (ImGui::SmallButton(u8"测试2"))
			//{
			...
			//if (ImGui::IsWindowFocused()&& ImGui::GetIO().WantCaptureMouse)
			{
				...
				ImGui::PushStyleColor(ImGuiCol_Button, (ImVec4)ImColor::HSV(scroll_x / 120.0f / daxiao_ * 0.01031f, 0.6f, 0.6f, 0.44f));
				ImGui::PushStyleColor(ImGuiCol_ButtonHovered, (ImVec4)ImColor::HSV(scroll_x / 120.0f / daxiao_ * 0.01031f, 0.6f, 0.6f, 0.44f));
				ImGui::PushStyleColor(ImGuiCol_ButtonActive, (ImVec4)ImColor::HSV(scroll_x / 120.0f / daxiao_ * 0.01031f, 0.6f, 0.6f, 0.44f));
